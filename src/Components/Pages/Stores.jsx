      ...
      <div className="container store-wrap my-5 py-5">
        <div className="row">
          <div className="section-title mb-5 stores-title text-center">
            ...
            <p>
              We’re talking about clean beauty gift sets, of course <br />
              and we’ve got a bouquet of beauties for yourself o
            </p>
          </div>
        </div>
          ...
          <div className="col-lg-6">
            ...
            <div className="row">
              <div className="col-md-6 mb-4">
                ...
                <p className="text-muted mb-0">3242 Mymensingh BLVD</p>
            ...
            <div className="row">
              <div className="col-md-6 mb-4">
                ...
                <p className="text-muted mb-0">
                  Mobile: <strong className="text-dark">01316884689</strong>
                </p>
                <p className="text-muted mb-0">
                  Mobile: <strong className="text-dark">01794985731</strong>
                </p>
                <p className="text-muted">E-mail: mdtohid232020@gmail.com</p>
              </div>
        ...
        <div className="container store-wrap my-5 py-5">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              ...
              <div className="row">
                <div className="col-md-6 mb-4">
                  <h5 className="subtitle fw-semibold mb-4">Address</h5>
                  <p className="text-muted mb-0">3422 AMymensingh BLVD</p>
          ...
          <div className="row">
            <div className="col-md-6 mb-4">
              ...
              <p className="text-muted">E-mail: mdtohid232020@gmsil.com</p>
            </div>
